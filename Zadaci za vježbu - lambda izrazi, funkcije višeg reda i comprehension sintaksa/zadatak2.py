...
#3. Koristeći odgovarajuću funkciju višeg reda i lambda izraz (bez comprehensiona), 
    #pohranite u varijablu transform rezultat kvadriranja svih brojeva u listi gdje rezultat mora biti rječnik gdje su ključevi originalni brojevi,
...
#5. Definirajte varijablu min_duljina koja će pohranjivati int . 
    #Koristeći odgovarajuću funkciju višeg reda i lambda izraz, pohranite u varijablu duge_rijeci sve riječi iz liste rijeci koje su dulje od min_duljina :
...
print(duge_rijeci)  # Ispis: ['zvijezda', 'prijatelj', 'čokolada', 'otorinolaringolog']
